const vue = new Vue({
    ...
    methods: {
        ...
        addFechaRows() {
            ...
            this.listaDatos.splice(0, 0, { fecha: 'Viernes 12 de Abril', colspan: 5 });
            this.listaDatos.splice(3, 0, { fecha: 'Sábado 13 de Abril', colspan: 5 });
            this.listaDatos.splice(11, 0, { fecha: 'Domingo 14 de Abril', colspan: 5 });
        }
    } // fin methods
});
