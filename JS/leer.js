const vue = new Vue({
    ...
    methods: {
        ...
        addFechaRows() {
            ...
            this.listaDatos.splice(0, 0, { fecha: 'Jueves 07 de Marzo', colspan: 5 });

            this.listaDatos.splice(5, 0, { fecha: 'Sábado 09 de Marzo', colspan: 5 });

            this.listaDatos.splice(8, 0, { fecha: 'Domingo 10 de Marzo', colspan: 5 });
        }
    } // fin methods
});
